...
simpletest()
{
  ...
  12:	c7250513          	addi	a0,a0,-910 # c80 <malloc+0xee>
  ...
  80:	c5450513          	addi	a0,a0,-940 # cd0 <malloc+0x13e>
  ...
  a6:	bee50513          	addi	a0,a0,-1042 # c90 <malloc+0xfe>
  ...
  c0:	bec50513          	addi	a0,a0,-1044 # ca8 <malloc+0x116>
  ...
  ea:	bd250513          	addi	a0,a0,-1070 # cb8 <malloc+0x126>
...
threetest()
{
 ...
 114:	bc850513          	addi	a0,a0,-1080 # cd8 <malloc+0x146>
 ...
 1a0:	b3450513          	addi	a0,a0,-1228 # cd0 <malloc+0x13e>
 ...
 1c4:	ad050513          	addi	a0,a0,-1328 # c90 <malloc+0xfe>
 ...
 1de:	b0650513          	addi	a0,a0,-1274 # ce0 <malloc+0x14e>
 ...
 244:	ab050513          	addi	a0,a0,-1360 # cf0 <malloc+0x15e>
 ...
 27e:	a8650513          	addi	a0,a0,-1402 # d00 <malloc+0x16e>
 ...
 298:	a6c50513          	addi	a0,a0,-1428 # d00 <malloc+0x16e>
 ...
 2b6:	a0650513          	addi	a0,a0,-1530 # cb8 <malloc+0x126>
...
filetest()
{
 ...
 2dc:	a3850513          	addi	a0,a0,-1480 # d10 <malloc+0x17e>
 ...
 376:	95e50513          	addi	a0,a0,-1698 # cd0 <malloc+0x13e>
 ...
 392:	98a50513          	addi	a0,a0,-1654 # d18 <malloc+0x186>
 ...
 3ac:	93850513          	addi	a0,a0,-1736 # ce0 <malloc+0x14e>
 ...
 40a:	93a50513          	addi	a0,a0,-1734 # d40 <malloc+0x1ae>
 ...
 424:	90850513          	addi	a0,a0,-1784 # d28 <malloc+0x196>
 ...
 448:	91c50513          	addi	a0,a0,-1764 # d60 <malloc+0x1ce>
 ...
 46c:	91050513          	addi	a0,a0,-1776 # d78 <malloc+0x1e6>
...
main(int argc, char *argv[])
{
 ...
 4be:	8de50513          	addi	a0,a0,-1826 # d98 <malloc+0x206>
...
putc(int fd, char c)
{
 ...
 804:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
 808:	4605                	li	a2,1
 80a:	fef40593          	addi	a1,s0,-17
 80e:	00000097          	auipc	ra,0x0
 812:	f6e080e7          	jalr	-146(ra) # 77c <write>
}
 816:	60e2                	ld	ra,24(sp)
 818:	6442                	ld	s0,16(sp)
 81a:	6105                	addi	sp,sp,32
 81c:	8082                	ret

000000000000081e <printint>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 82c:	84aa                	mv	s1,a0
  ...
  neg = 0;
  if(sgn && xx < 0){
 82e:	c299                	beqz	a3,834 <printint+0x16>
 830:	0805c863          	bltz	a1,8c0 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 834:	2581                	sext.w	a1,a1
  neg = 0;
 836:	4881                	li	a7,0
 838:	fc040693          	addi	a3,s0,-64
  }
 ...
 83c:	4701                	li	a4,0
  do{
    buf[i++] = digits[x % base];
 83e:	2601                	sext.w	a2,a2
 840:	00000517          	auipc	a0,0x0
 844:	57850513          	addi	a0,a0,1400 # db8 <digits>
 848:	883a                	mv	a6,a4
 84a:	2705                	addiw	a4,a4,1
 84c:	02c5f7bb          	remuw	a5,a1,a2
 850:	1782                	slli	a5,a5,0x20
 852:	9381                	srli	a5,a5,0x20
 854:	97aa                	add	a5,a5,a0
 856:	0007c783          	lbu	a5,0(a5)
 85a:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
 85e:	0005879b          	sext.w	a5,a1
 862:	02c5d5bb          	divuw	a1,a1,a2
 866:	0685                	addi	a3,a3,1
 868:	fec7f0e3          	bgeu	a5,a2,848 <printint+0x2a>
  if(neg)
 86c:	00088b63          	beqz	a7,882 <printint+0x64>
    buf[i++] = '-';
 870:	fd040793          	addi	a5,s0,-48
 ...
 87e:	0028071b          	addiw	a4,a6,2
  ...
  while(--i >= 0)
 882:	02e05863          	blez	a4,8b2 <printint+0x94>
 ...
 8a8:	f58080e7          	jalr	-168(ra) # 7fc <putc>
  while(--i >= 0)
 8ac:	197d                	addi	s2,s2,-1
 8ae:	ff3918e3          	bne	s2,s3,89e <printint+0x80>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 8f8:	02500a13          	li	s4,37
      if(c == 'd'){
 8fc:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
 900:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
 904:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
 908:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 90c:	00000b97          	auipc	s7,0x0
 910:	4acb8b93          	addi	s7,s7,1196 # db8 <digits>
 914:	a839                	j	932 <vprintf+0x6a>
        putc(fd, c);
 916:	85ca                	mv	a1,s2
 918:	8556                	mv	a0,s5
 91a:	00000097          	auipc	ra,0x0
 91e:	ee2080e7          	jalr	-286(ra) # 7fc <putc>
 922:	a019                	j	928 <vprintf+0x60>
    } else if(state == '%'){
 924:	01498f63          	beq	s3,s4,942 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
 928:	0485                	addi	s1,s1,1
 92a:	fff4c903          	lbu	s2,-1(s1)
 92e:	14090d63          	beqz	s2,a88 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
 932:	0009079b          	sext.w	a5,s2
    if(state == 0){
 936:	fe0997e3          	bnez	s3,924 <vprintf+0x5c>
      if(c == '%'){
 93a:	fd479ee3          	bne	a5,s4,916 <vprintf+0x4e>
        state = '%';
 93e:	89be                	mv	s3,a5
 940:	b7e5                	j	928 <vprintf+0x60>
      if(c == 'd'){
 942:	05878063          	beq	a5,s8,982 <vprintf+0xba>
      } else if(c == 'l') {
 946:	05978c63          	beq	a5,s9,99e <vprintf+0xd6>
      } else if(c == 'x') {
 94a:	07a78863          	beq	a5,s10,9ba <vprintf+0xf2>
      } else if(c == 'p') {
 94e:	09b78463          	beq	a5,s11,9d6 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
 952:	07300713          	li	a4,115
 956:	0ce78663          	beq	a5,a4,a22 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 95a:	06300713          	li	a4,99
 95e:	0ee78e63          	beq	a5,a4,a5a <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
 962:	11478863          	beq	a5,s4,a72 <vprintf+0x1aa>
        putc(fd, c);
      } else {
 ...
 96e:	e92080e7          	jalr	-366(ra) # 7fc <putc>
        putc(fd, c);
 972:	85ca                	mv	a1,s2
 974:	8556                	mv	a0,s5
 976:	00000097          	auipc	ra,0x0
 97a:	e86080e7          	jalr	-378(ra) # 7fc <putc>
      }
      state = 0;
 97e:	4981                	li	s3,0
 ...
 994:	e8e080e7          	jalr	-370(ra) # 81e <printint>
 998:	8b4a                	mv	s6,s2
      state = 0;
 99a:	4981                	li	s3,0
 ...
 9b0:	e72080e7          	jalr	-398(ra) # 81e <printint>
 9b4:	8b4a                	mv	s6,s2
      state = 0;
 9b6:	4981                	li	s3,0
 ...
 9cc:	e56080e7          	jalr	-426(ra) # 81e <printint>
 9d0:	8b4a                	mv	s6,s2
      state = 0;
 9d2:	4981                	li	s3,0
 9d4:	bf91                	j	928 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
 9d6:	008b0793          	addi	a5,s6,8
 9da:	f8f43423          	sd	a5,-120(s0)
 9de:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
 9e2:	03000593          	li	a1,48
 9e6:	8556                	mv	a0,s5
 9e8:	00000097          	auipc	ra,0x0
 9ec:	e14080e7          	jalr	-492(ra) # 7fc <putc>
  putc(fd, 'x');
 9f0:	85ea                	mv	a1,s10
 9f2:	8556                	mv	a0,s5
 9f4:	00000097          	auipc	ra,0x0
 9f8:	e08080e7          	jalr	-504(ra) # 7fc <putc>
 9fc:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 a0e:	df2080e7          	jalr	-526(ra) # 7fc <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 a12:	0992                	slli	s3,s3,0x4
 a14:	397d                	addiw	s2,s2,-1
 a16:	fe0914e3          	bnez	s2,9fe <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
 a1a:	f8843b03          	ld	s6,-120(s0)
      state = 0;
 a1e:	4981                	li	s3,0
 a20:	b721                	j	928 <vprintf+0x60>
        s = va_arg(ap, char*);
 a22:	008b0993          	addi	s3,s6,8
 a26:	000b3903          	ld	s2,0(s6)
        if(s == 0)
 a2a:	02090163          	beqz	s2,a4c <vprintf+0x184>
        while(*s != 0){
 a2e:	00094583          	lbu	a1,0(s2)
 a32:	c9a1                	beqz	a1,a82 <vprintf+0x1ba>
          putc(fd, *s);
 a34:	8556                	mv	a0,s5
 a36:	00000097          	auipc	ra,0x0
 a3a:	dc6080e7          	jalr	-570(ra) # 7fc <putc>
          s++;
 a3e:	0905                	addi	s2,s2,1
        while(*s != 0){
 a40:	00094583          	lbu	a1,0(s2)
 a44:	f9e5                	bnez	a1,a34 <vprintf+0x16c>
        s = va_arg(ap, char*);
 a46:	8b4e                	mv	s6,s3
      state = 0;
 a48:	4981                	li	s3,0
 a4a:	bdf9                	j	928 <vprintf+0x60>
          s = "(null)";
 a4c:	00000917          	auipc	s2,0x0
 a50:	36490913          	addi	s2,s2,868 # db0 <malloc+0x21e>
        while(*s != 0){
 a54:	02800593          	li	a1,40
 a58:	bff1                	j	a34 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
 a5a:	008b0913          	addi	s2,s6,8
 a5e:	000b4583          	lbu	a1,0(s6)
 a62:	8556                	mv	a0,s5
 a64:	00000097          	auipc	ra,0x0
 a68:	d98080e7          	jalr	-616(ra) # 7fc <putc>
 a6c:	8b4a                	mv	s6,s2
      state = 0;
 a6e:	4981                	li	s3,0
 a70:	bd65                	j	928 <vprintf+0x60>
        putc(fd, c);
 a72:	85d2                	mv	a1,s4
 a74:	8556                	mv	a0,s5
 a76:	00000097          	auipc	ra,0x0
 a7a:	d86080e7          	jalr	-634(ra) # 7fc <putc>
      state = 0;
 a7e:	4981                	li	s3,0
...
free(void *ap)
{
 ...
 b1c:	a805                	j	b4c <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
 b1e:	4618                	lw	a4,8(a2)
 b20:	9db9                	addw	a1,a1,a4
 b22:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
 b26:	6398                	ld	a4,0(a5)
 b28:	6318                	ld	a4,0(a4)
 b2a:	fee53823          	sd	a4,-16(a0)
 b2e:	a091                	j	b72 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
 b30:	ff852703          	lw	a4,-8(a0)
 b34:	9e39                	addw	a2,a2,a4
 b36:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
 b38:	ff053703          	ld	a4,-16(a0)
 b3c:	e398                	sd	a4,0(a5)
 b3e:	a099                	j	b84 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 b40:	6398                	ld	a4,0(a5)
 b42:	00e7e463          	bltu	a5,a4,b4a <free+0x40>
 b46:	00e6ea63          	bltu	a3,a4,b5a <free+0x50>
{
 b4a:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 b4c:	fed7fae3          	bgeu	a5,a3,b40 <free+0x36>
 b50:	6398                	ld	a4,0(a5)
 b52:	00e6e463          	bltu	a3,a4,b5a <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 b56:	fee7eae3          	bltu	a5,a4,b4a <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
 b5a:	ff852583          	lw	a1,-8(a0)
 b5e:	6390                	ld	a2,0(a5)
 b60:	02059713          	slli	a4,a1,0x20
 b64:	9301                	srli	a4,a4,0x20
 b66:	0712                	slli	a4,a4,0x4
 b68:	9736                	add	a4,a4,a3
 b6a:	fae60ae3          	beq	a2,a4,b1e <free+0x14>
    bp->s.ptr = p->s.ptr;
 b6e:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 b72:	4790                	lw	a2,8(a5)
 b74:	02061713          	slli	a4,a2,0x20
 b78:	9301                	srli	a4,a4,0x20
 b7a:	0712                	slli	a4,a4,0x4
 b7c:	973e                	add	a4,a4,a5
 b7e:	fae689e3          	beq	a3,a4,b30 <free+0x26>
  } else
    p->s.ptr = bp;
 b82:	e394                	sd	a3,0(a5)
  freep = p;
...
malloc(uint nbytes)
{
 ...
 be2:	42a90913          	addi	s2,s2,1066 # 1008 <freep>
  if(p == (char*)-1)
 be6:	5afd                	li	s5,-1
 be8:	a88d                	j	c5a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 bea:	00004797          	auipc	a5,0x4
 bee:	42678793          	addi	a5,a5,1062 # 5010 <base>
 ...
 c00:	b7e1                	j	bc8 <malloc+0x36>
      if(p->s.size == nunits)
 c02:	02e48b63          	beq	s1,a4,c38 <malloc+0xa6>
        p->s.size -= nunits;
 c06:	4137073b          	subw	a4,a4,s3
 c0a:	c798                	sw	a4,8(a5)
        p += p->s.size;
 c0c:	1702                	slli	a4,a4,0x20
 c0e:	9301                	srli	a4,a4,0x20
 c10:	0712                	slli	a4,a4,0x4
 c12:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
 c14:	0137a423          	sw	s3,8(a5)
      freep = prevp;
 c18:	00000717          	auipc	a4,0x0
 c1c:	3ea73823          	sd	a0,1008(a4) # 1008 <freep>
      return (void*)(p + 1);
 ...
 c30:	6aa2                	ld	s5,8(sp)
 c32:	6b02                	ld	s6,0(sp)
 c34:	6121                	addi	sp,sp,64
 c36:	8082                	ret
        prevp->s.ptr = p->s.ptr;
 c38:	6398                	ld	a4,0(a5)
 c3a:	e118                	sd	a4,0(a0)
 c3c:	bff1                	j	c18 <malloc+0x86>
  hp->s.size = nu;
 c3e:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
 c42:	0541                	addi	a0,a0,16
 c44:	00000097          	auipc	ra,0x0
 c48:	ec6080e7          	jalr	-314(ra) # b0a <free>
  return freep;
 c4c:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 c50:	d971                	beqz	a0,c24 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 c52:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 c54:	4798                	lw	a4,8(a5)
 c56:	fa9776e3          	bgeu	a4,s1,c02 <malloc+0x70>
    if(p == freep)
 c5a:	00093703          	ld	a4,0(s2)
 c5e:	853e                	mv	a0,a5
 c60:	fef719e3          	bne	a4,a5,c52 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
 c64:	8552                	mv	a0,s4
 c66:	00000097          	auipc	ra,0x0
 c6a:	b7e080e7          	jalr	-1154(ra) # 7e4 <sbrk>
  if(p == (char*)-1)
 c6e:	fd5518e3          	bne	a0,s5,c3e <malloc+0xac>
        return 0;
 c72:	4501                	li	a0,0
 c74:	bf45                	j	c24 <malloc+0x92>
